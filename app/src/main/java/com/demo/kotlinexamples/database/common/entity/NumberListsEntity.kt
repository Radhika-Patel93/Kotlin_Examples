...
@Entity(
    ...
    indices = [Index(value = [NumberListsEntity.PRIMARY_KEY], unique = true)]
)
data class NumberListsEntity(
    @PrimaryKey
    ...
    @Embedded(prefix = "contacts_") val contacts: Contacts? = null,
    @ColumnInfo(name = "white_list") val whiteList: String? = null,
    @ColumnInfo(name = "block_list") val blockList: String? = null,
    @ColumnInfo(name = "raw_data") val rawData: String? = null
) : BaseEntity {
    companion object {
        const val TABLE_NAME = "number_lists"
